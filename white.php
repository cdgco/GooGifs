...
<form id="randomform" action="white.php" method="get"></form>
		<input name="sclient" type="hidden" value="psy-ab" form="tsf">

		<div id="searchContainer">
			<input form="tsf" id="field" style="position: relative; top: -82px; height:39.6px; length: 543px;" name="q" maxlength="2048" autocomplete="off" title="Search" type="text" value="" aria-label="Search" aria-haspopup="false" role="combobox" aria-autocomplete="both" spellcheck="false" autofocus>
		</div>

		<div style="padding-top:18px; white-space: nowrap; display:inline; position:relative; top: -55px;">

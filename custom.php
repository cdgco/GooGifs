...
<div class="middle">
<div class="inner">
						<p style="text-align:center; display:inline-block; font-family: 'Product Sans', Arial, sans-serif; font-size: 90px;"><span id="custom"><?php print_r($_GET['name']) ?></span></p>
		...
		<div style="padding-top:18px">
			<input aria-label="Google Search" class="button default" name="btnK" type="submit" value="<?php print_r($_GET['name']) ?> Search">

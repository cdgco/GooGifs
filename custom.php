			...
			<form action="/search" class="tsf" id="tsf" method="get" name="f" onsubmit="return q.value!=''" role="search" style="overflow:visible">
				...
				<div class="tsf-p">
					...
					<div class="jsb" style="padding-top:18px">
						<center>
							<input aria-label="Google Search" name="btnK" type="submit" value="<?php print_r($_GET['name']) ?> Search"> <input aria-label="I'm Feeling Lucky" id="gbqfbb" name="btnI" type="submit" value="I'm Feeling Lucky">
						</center>
					</div>
				</div>
		...
		<div class="content" data-jiis="cc" id="main">
			...
			<center>
				...
				<div id="lga" style="height:233px;margin-top:175px">
					...
					<div class="kyle" id="customsection">
						<span class="ctr-p" data-jiis="bp" id="body"></span>

						<center>
							<h1 class="ctr-p" data-jiis="bp" id="body" style="font-family: 'Product Sans', Arial, sans-serif;"><span id="custom"><?php print_r($_GET['name']) ?></span>
							</h1>
						</center>
					</div>
			...
			<script>
			var options={ "publisher": "PUBLISHER-ID-GOES-HERE", "position": "left", "ad": { "visible": false, "openDelay": 0, "closeDelay": 0}, "chicklets": { "items": ["facebook", "twitter", "email"]}}; var st_hover_widget = new sharethis.widgets.hoverbuttons(options);
			</script>
		</div>
	</div>
</body>

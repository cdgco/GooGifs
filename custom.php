...
<head>
	...
	<title><?php print_r($_GET['name']) ?></title>
</head>
...
<div class="middle">
<div class="inner">
       <div style="height:15px;font-size:1px;">&nbsp;</div>						<p style="text-align:center; display:inline-block; font-family: 'Product Sans', Arial, sans-serif; font-size: 90px;"><span id="custom" style="color:<?php print_r($_GET['c']) ?>;"><?php print_r($_GET['name']) ?></span></p>
...
<form id="randomform" action="custom.php" method="GET"></form>
		<input name="sclient" type="hidden" value="psy-ab" form="tsf">

		<div id="searchContainer">
			<input form="tsf" id="field" style="position: relative;  top: -65px; height:39.6px; length: 543px;" name="q" maxlength="2048" autocomplete="off" title="Search" type="text" value="" aria-label="Search" aria-haspopup="false" role="combobox" aria-autocomplete="both" spellcheck="false" autofocus>
		</div>
<div style="height:25px;font-size:1px;">&nbsp;</div>
		<div style="padding-top:18px; white-space: nowrap; display:inline; position:relative; top: 0px;">
			<input form="tsf" aria-label="Google Search" class="button default" name="btnK" style="position:absolute; top: -65px; right: 20px;" type="submit" value="Google Search">
				<div id="subform" style="white-space: nowrap; display:inline;">
					<input title="Previous" class="button default" name="gifnumber" style="display:none; position:absolute; z-index: 4000; top: -65px; left: 0px;" type="submit" value="&#9664;" id="prev">
					<input title="Random Gif" class="button default" form="randomform" name="randombg" onclick="$.backstretch("<?php include 'random-api.php'; print_r($random . '?v=' . + 1); ?>");" style="position:absolute; top: -65px;" type="submit" id="random" value="Random">
 					<input title="Next" class="button default" name="gifnumber" style="display:none;position:absolute; top: -65px; left: 95px;" type="submit" id="next" value="&#9658;">
				</div>
<div id="output"></div>
		</div>
		...
		<input name="pbx" form="tsf" type="hidden" value="1">
                <input name="name" form="randomform" type="hidden" value="<?php print_r($_GET['name']) ?>">
                <input name="c" form="randomform" type="hidden" value="<?php print_r($_GET['c']) ?>">

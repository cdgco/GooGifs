...
<html>
  ...
  @media screen and (max-width: 485px) {
    ...
    .primary-text-color {
      color: rgba(25, 173, 216, 1) !important;
    }
    ...
    .border-button {
      color: rgba(25, 173, 216, 1) !important;
      border-color: rgba(25, 173, 216, 1) !important;
    }
    .button {
      background-color: rgba(25, 173, 216, 1) !important;
 ...
 <body class="plain error-page-wrapper background-color background-image">
	<br>
		<br>
<h1>Configuration Tester</h1>
	<br>
		<br><br>
		Your ShareThis Publish Key Is Currently Set as: <?php include 'config.php'; echo $pubkey ?><br><br>
                <hr style="color:black">
		<br>
		Your API Key is set as: <?php include 'config.php'; print_r($apikey) ?><br>
		<br>
		The Random Generator API URL is set as: <?php include 'random-api.php'; print_r($r1); ?><br><br>
		<hr style="color:black"><br>
		Your Support email is set as: <?php include 'config.php'; print_r($email) ?>
		<br>
		<br><hr style="color:black"><br><br>
		To change these values, <a href="install">re-install the configuration</a>.<br><br><p>It is recommended that you delete the "install" directory after you have configured these values.</p><br><a href="index.php">Go to Home</a>
	    <script>
